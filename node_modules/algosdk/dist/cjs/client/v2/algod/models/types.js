...
class SimulateResponse extends basemodel_1.default {
     ...
     */
    constructor({ lastRound, txnGroups, version, evalOverrides, }) {
        super();
        this.lastRound = lastRound;
        this.txnGroups = txnGroups;
